...
"""
    ...
    This file git_upy/cinema4d/r12/c4dPlugin.py is part of upy.
...
#        dir, file = os.path.split(__file__)
        ...
        if image_filename is not None :
            ...
            print(os.path.join(self.prefdir+os.sep+"plugins"+os.sep+self.plugin_dir,"res",image_name)) 
    ...
    def setGeRessource(self,res,path=None):
        if path is None :
            path = os.path.join(self.prefdir+os.sep+"plugins"+os.sep+self.plugin_dir,"res")
