...
#                setattr(self,propName+"_o",None))
                ...
                print (propName,name)
                #problem of name. should I use a prefix§
...
#        Blender.BGL.glRasterPos2i(x,y+5)
        if elem["show"]:
            self.current_layout.label(text=label)
...
#        clascode += "        layout = self.layout\n"
#        clascode += "        row = layout.row()\n"
#        clascode += "        row.label(text=bpy.types.Scene.labelstring)\n"
